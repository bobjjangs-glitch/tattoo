...
// $actorRole 은 store.php처럼 직원 로그인을 지원하는 페이지에서만 설정됨 (owner/admin/staff)
$actorRole = $actorRole ?? 'owner';
$canSeeSettings = ($actorRole === 'owner');
?>
<aside class="sidebar">
  <div class="sidebar-logo"><span class="logo-text">SalonForm</span></div>
  <nav class="sidebar-nav">
    <?php if ($actorRole === 'owner'): ?>
  ...
  <div class="sidebar-footer">
    <form method="POST" action="<?php echo $actorRole === 'owner' ? 'logout.php' : 'staff-logout.php'; ?>">
